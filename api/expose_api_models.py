...
def expose_models(api, method_decorators = []): 
    ...
    api.expose_object(database.models.ClientPayment, method_decorators= method_decorators)
    api.expose_object(database.models.Owner, method_decorators= method_decorators)
    api.expose_object(database.models.DogHistory, method_decorators= method_decorators)
    ...
    api.expose_object(database.models.WalkerPayment, method_decorators= method_decorators)
    return api
