...
@Component({
  selector: 'ClientPayment-home',
  templateUrl: './ClientPayment-home.component.html',
  styleUrls: ['./ClientPayment-home.component.scss']
})
export class ClientPaymentHomeComponent implements AfterViewInit {
