...
@Component({
  selector: 'WalkerPayment-home',
  templateUrl: './WalkerPayment-home.component.html',
  styleUrls: ['./WalkerPayment-home.component.scss']
})
export class WalkerPaymentHomeComponent implements AfterViewInit {
