...
@Component({
  selector: 'DogHistory-home',
  templateUrl: './DogHistory-home.component.html',
  styleUrls: ['./DogHistory-home.component.scss']
})
export class DogHistoryHomeComponent implements AfterViewInit {
